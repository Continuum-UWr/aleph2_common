...
class Aleph2ManipKinematics {
 public:
   ...
   *
   * @param check_collision if set to true, self-collision checking will be
  ...
  bool setPose(const geometry_msgs::Pose &pose,
               geometry_msgs::Pose &result_pose, KinematicsError &err);
   ...
   * @return true, if the position was set successfully, false otherwise
   */
  bool setPose(const geometry_msgs::Point &position, const double &pitch,
               geometry_msgs::Pose &result_pose, KinematicsError &err);
   ...
   * @return true, if the position was set successfully, false otherwise
   */
  bool setPose(const std::string &group_state, geometry_msgs::Pose &result_pose,
               KinematicsError &err);
 ...
 private:
  ...
  bool getFKPose(const std::vector<double> &joint_pos,
